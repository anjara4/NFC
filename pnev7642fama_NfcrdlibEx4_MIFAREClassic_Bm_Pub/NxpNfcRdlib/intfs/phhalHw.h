...
#define PHHAL_HW_RC663_SHADOW_COUNT     0x0010U  /**< Number of shadowed configurations. */
    /**
     * This macro needs to be fine tuned by customer to be at 500 microseconds from
     * PICC response to PCD T1T Poll command.
     */
#define PHHAL_HW_RC663_T1T_FDT_POLL_DELTA    200U  /**< T1T FDT POll Delta in microseconds. */

    /**
     * \name LPCD Options
     * When configuring Filter ON then either of the below options should be provided by the User.
     * For more information refer AN11783 available at www.nxp.com/docs/en/application-note/AN11783.pdf
     */
    /*@{*/
...
#define PHHAL_HW_RC663_FILTER_OPTION2   0x0200U  /**< Configure I and Q value for LPCD for higher detection range. */
    ...
    /**
     * \brief Enable (#PH_ON) or disable (#PH_OFF) Update antenna parameters.
     *
     * \name Update antenna parameters.
     * Note: These register values are arrived based on best performance for ISO/IEC15693 protocol for 65x65 antenna.
     * #PHHAL_HW_RC663_REG_DRVCON register default value as per data sheet is 0x01, same is updated to 0x09.
     * #PHHAL_HW_RC663_REG_RXTHRESHOLD register default value as per data sheet is 0x74, same is updated 0x28.
     * #PHHAL_HW_RC663_REG_RXANA register default value as per data sheet is 0x07, same is updated to 0x03.
     * #PHHAL_HW_RC663_REG_RXSVETTE register default value as per data sheet is 0xF0, same is updated to 0xB2.
     */
    /*@{*/
#define PHHAL_HW_RC663_UPDATE_ANT_PARAMS   PH_ON  /**< Update antenna parameters for ISO/IEC15693 protocol for 65x65 antenna. */
    /*@}*/
...
#define PHHAL_HW_RC663_TX_AMP_TVDD_MINUS_1000MV     0xC0U
    ...
    /**
     * Set RC663 65*65 Antenna specific configurations for ISO15693 Performance improvement.
     * Valid values are #PH_ON, #PH_OFF
     * */
#define PHHAL_HW_RC663_CONFIG_ANTENNA_PARAMETERS    (PH_CONFIG_CUSTOM_BEGIN+6U)
...
#define PHHAL_HW_RC663_ARR_LDREG_FILL(EEADDR)                                                           \
    ...
    */
    typedef struct
    {
        ...
        uint8_t bEnAnt6565Config;                           /**< Enabled 65*65 antenna specific performance configurations for ISO15693. */
...
/**
 * \defgroup phhalHw_Pn7462AU component : Pn7462AU
 * \brief Pn7462AU HAL component
 *
 * @{
 */
...
/**
 * AGC sample delay time in micro second for the AGC measurement to settle.
 * Note: PHHAL_HW_CONFIG_PN7462AU_LPCD_DURATION is effective only when DPC feature (or) TX OCP is disabled.
 * PHHAL_HW_CONFIG_PN7462AU_LPCD_DURATION configuration allowed values are from 40 to 150 micro seconds.
 */
...
typedef struct phhalHw_PN7462AU_DataParams
{
    ...
    uint8_t bTimerDeviation;        /**< Platform timer deviation percentage. */
...
phStatus_t phhalHw_PN7462AU_SetListenParam(phhalHw_PN7462AU_DataParams_t * pDataParams, /**< [In] Pointer to this layer's parameter structure. */
                                           uint8_t* pSensRes,                           /**< [In] Pointer containing the address of 2 byte sens response for ISO14443- Type A. */
                                           uint8_t* pNfcid1,                            /**< [In] Pointer containing the address of  3 byte UID for ISO14443- Type A, first byte being 0x08. */
                                           uint8_t bSelRes,                             /**< [In] Response to select i.e. sak for ISO14443- Type A. */
                                           uint8_t bSupportT3T,                         /**< [In] If set to 0 supports Nfc dep else Type 3 Tag for FeliCa. */
                                           uint8_t* pNfcid2,                            /**< [In] Pointer containing the address of 6 byte NFCID2 for FeliCa. */
                                           uint8_t* pPad,                               /**< [In] Pointer containing the address of 8 pad Bytes for FeliCa. */
                                           uint8_t* pSystemCode                         /**< [In] Pointer containing the address of 2 byte system code for FeliCa. */
                                           );
 ...
 */
    typedef struct
    {
        ...
        uint16_t wLpcdReference;                            /**< Reference value read from AGC_REF_CONFIG (check_card) register. */
...
#define PHHAL_HW_PN5190_DEFAULT_FELICA_EMD_REGISTER 0x00FF0019U  /**< FeliCa EMD Control register default value */

#define PH_PN5190_EVT_RSP                           0x80        /**< Mask for Event filed in the Response byte */

/**
* \name Event generated by PN5190 \n
*  Any of these events can be triggered by PN5190 Synchronously or Asynchronously
*  based on previous command execution or based on the internal error events generated
*  by PN5190 Reader IC.
*/
/*@{
 *
 * \anchor pn5190_events
 */

#define PH_PN5190_EVT_BOOT                          0x0001      /**< Boot Event */
...
#define PH_PN5190_EVT_TX_OVERCURRENT_ERROR          0x0020      /**< TX Over Current Error Event */
...
#define PH_PN5190_EVT_RFU                           0x1000      /**< CTS Event */

/*@}*/

/**
* \name SWITCH_MODE_NORMAL CMD used to terminate an ongoing PN5190 CMD execution.
*  PH_PN5190_EVT_IDLE Event shall be generated by PN5190.
*/
/*@{
 *
 * \anchor pn5190_switch_mode_normal_cmd
 */
#define PH_PN5190_SWITCH_MODE_NORMAL_2_1            0x0001      /**< SWITCH MODE NORMAL Usecase 2.1 CMD */
#define PH_PN5190_SWITCH_MODE_NORMAL_2_2            0x0002      /**< SWITCH MODE NORMAL Usecase 2.2 CMD: This CMD is supported from PN5190 FW v02.02 and greater. */
/*@}*/

#define PH_ERR_PN5190_NO_CTS_EVENT                  PH_ERR_CUSTOM_BEGIN      /**< Error returned by PN5190 HAL indicating no CTS Event occurred. */
 ...
 */
    typedef struct
    {
        ...
        uint16_t wWakeupCounterInMs;                        /**< Used value for wakeup counter in msecs, i.e. after this amount of time PN5190 wakes up from standby. Maximum value is 2690. */

        uint16_t wLPCDWakeupCounterInMs;                    /**< Wakeup counter in msec for LPCD*/
        uint8_t bPollGuardTimeFlag;                         /**< Poll Guard Time Flag. */
        uint8_t bLpcdConfig;                                /**< LPCD Configuration. */
        uint8_t bLpcdMode;                                  /**< LPCD Mode options either DEFAULT or POWERDOWN mode. */
        uint8_t bLpcdWakeUpCtrl;                            /**< Mask Controlling wake-up source for HW LPCD. */
        uint8_t bSymbolStart;                               /**< Preamble of a frame. */
        uint8_t bSymbolEnd;                                 /**< Trailer symbol of a frame. */
        uint8_t bRfResetAfterTo;                            /**< Storage for #PHHAL_HW_CONFIG_RFRESET_ON_TIMEOUT setting. */
        ...
        uint8_t bTimeoutUnit;                               /**< Unit of current timeout value (either #PHHAL_HW_TIME_MICROSECONDS or #PHHAL_HW_TIME_MILLISECONDS). */
        uint16_t wTimingMode;                               /**< Current timing measurement mode. */
        uint32_t dwTimingUs;                                /**< PICC Current timing value. */
        uint8_t bRxMultiple;                                /**< Flag indicates whether RX multiple is to be enabled  or not. */

        uint8_t bMfcCryptoEnabled;                          /**< Flag indicates whether the MFC Crypto is enabled or not. */
        uint8_t bCardMode;                                  /**< Flag indicates whether the SYSTEM_CONFIG_AUTOCOLL_STATE_A_MASK bit is set or not. */

        uint8_t bCmdAborted;                                /**< Flag indicates whether the command was Aborted previously. */
        ...
        phIrqResp_t sIrqResp;                               /**< Structure to be filled by ISR HAL Callback, contains minimal response read in ISR */
        ...
        uint8_t bRFONEvent;                                 /**< Flag indicating if RF ON Event is received or not. */

        uint16_t wAdditionalInfo;                           /**< Storage for additional error information. */

        uint32_t dwEventStatus;                             /**< Storage for Event Status received as part of Event. */

        uint32_t dwGenError;                                /**< Storage for General Error received. */

        uint32_t dwEventReceived;                           /**< Storage for Events received after previous operation. */

        uint32_t dwLpcdRefVal;                              /**< Storage for LPCD reference value received after LPCD calibration. */

        uint8_t bHFATTVal;                                  /**< Stores HFATT Value for ULPCD calibration and detection cycle. */

        uint8_t bNfcipMode;                                 /**< Enable/Disable to handle Start Byte at 106kbps in NFCIP-1 mode. */

        uint16_t wCurrentSlotCount;                         /**< ISO 18000p3m3 slot count at time of buffer overflow (PH_ERR_SUCCESS_CHAINING). */

        uint32_t dwExpectedEvent;                           /**< ExpectedEvent is used by Event Wait, to process cmd specific events. */

        uint8_t bFeliCaRxOnly;                              /**< Flag indicating if Exchange needs to perform only Rx operation when configured as FeliCa Reader. */

        uint8_t bAbortCMD;                                  /**< Flag indicating which SWITCH MODE NORMAL Commmand needs to be sent to abort an ongoing CMD execution. */
...
phStatus_t phhalHw_Pn5190_SetListenParameters(
    ...
    uint8_t * pSensRes,                         /**< [In] 2 bytes. */
    uint8_t * pNfcId1,                          /**< [In] 3 bytes; The first NfcId1 byte is fixed to \c 08h and the check byte is calculated automatically. */
    uint8_t bSelRes,                            /**< [In] 1 byte. */
    uint8_t * pPollingResp,                     /**< [In] 2 bytes (shall be 01h, FEh) + 6 bytes NfcId2 + 8 bytes Pad + 2 bytes SystemCode. */
    uint8_t bNfcId3                             /**< [In] 1 byte. */
    );
...
/**
 * \defgroup phhalHw_Pn76xx component : Pn76xx
 * \brief Pn76xx HAL component
 *
 * @{
 */

#define PHHAL_HW_PN76XX_ID                              0x0DU        /**< ID for PN76XX HAL component. */
#define PHHAL_HW_PN76XX_SHADOW_COUNT                    0x10U        /**< PN76XX Shadow Register count. */
#define PHHAL_HW_PN76XX_DEFAULT_FELICA_EMD_REGISTER     0x00FF0019U  /**< FeliCa EMD Control register default value */

#ifdef NXPBUILD__PHHAL_HW_PN7640
    #define PHHAL_HW_PN76XX_SET_LISTEN_EEPROM_ADDR      0x2B3U
    #define PHHAL_HW_PN76XX_DYNAMIC_UID_CONFG_ADDR      0x2CBU
#endif /* NXPBUILD__PHHAL_HW_PN7640 */

#ifdef NXPBUILD__PHHAL_HW_PN7642
    #define PHHAL_HW_PN76XX_SET_LISTEN_EEPROM_ADDR      0x3C5U
    #define PHHAL_HW_PN76XX_DYNAMIC_UID_CONFG_ADDR      0x3DDU
#endif /* NXPBUILD__PHHAL_HW_PN7642 */

/**
* \name Event generated by PN76XX CLIF \n
*  Any of these events can be triggered by PN76XX Asynchronously.
*/
/*@{
 * \anchor pn76XX_events
 */

#define PH_PN76XX_EVT_RFOFF_DETECT                  0x0001      /**< RF OFF Detection Event */
#define PH_PN76XX_EVT_RFON_DETECT                   0x0002      /**< RF ON Detection Event */
#define PH_PN76XX_EVT_RFU                           0x0004      /**< CTS Event */
/*@}*/

/**
 * Set Listen Parameter Constants
 */
#define PHHAL_HW_PN76XX_SET_LISTEN_LEN              24U
#define PHHAL_HW_PN76XX_SET_LISTEN_SENRES_LEN       2U
#define PHHAL_HW_PN76XX_SET_LISTEN_NFCID1_LEN       3U
#define PHHAL_HW_PN76XX_SET_LISTEN_SELRES_LEN       1U
#define PHHAL_HW_PN76XX_SET_LISTEN_POLLRES_LEN      18U
#define PHHAL_HW_PN76XX_SET_LISTEN_NFCID3_LEN       1U

/**
* \name LPCD modes
*/
/*@{*/
#define PHHAL_HW_PN76XX_LPCD_MODE_DEFAULT            0x00U  /**< Default mode. Used to retrieve and configure the LPCD Calibration values. */
#define PHHAL_HW_PN76XX_LPCD_MODE_POWERDOWN          0x01U  /**< Powers down the IC for a certain amount of time and performs LPC after wakeup.
...
*/
/*@{*/
/**< Value used for Wakeup counter in msecs i.e. after this amount of time IC will perform LPCD Detection procedure. */
#define PHHAL_HW_CONFIG_SET_LPCD_WAKEUPTIME_MS       0x0070U
/**< Used to set options  PHHAL_HW_PN76XX_LPCD_MODE_DEFAULT or PHHAL_HW_PN76XX_LPCD_MODE_POWERDOWN */
#define PHHAL_HW_CONFIG_LPCD_MODE                    0x0071U
/**< Used to obtained the Reference value during Calibration phase of LPCD */
#define PHHAL_HW_CONFIG_LPCD_REF_VAL                 0x0074U
/*@}*/

/**
 * \brief Context Structure for PN76xxAU
 */
typedef struct phhalHw_PN76xx_DataParams
{
    uint16_t wId;                   /**< Layer ID for this HAL component, NEVER MODIFY! */
    uint8_t  bRfca;                 /**< Flag indicates whether RFCA is to be enabled or not (#PH_ON or #PH_OFF, default - #PH_ON). */
    uint8_t  bPollGuardTimeFlag;    /**< Poll Guard Time Flag. */
    ...
    uint8_t  bMfcCryptoEnabled;     /**< Flag indicates whether the MFC Crypto is enabled or not. */
    uint8_t  bCardMode;             /**< Flag indicates whether the SYSTEM_CONFIG_AUTOCOLL_STATE_A_MASK bit is set or not. */
    uint8_t  bOpeMode;              /**< Opemode of discloop differentiate between EMVCO, ISO and NFC mode */
    uint8_t  bEmdFlag;              /**< Flag to Indicate Enable EMD Suppression*/
    uint32_t dwFelicaEmdReg;        /**< FeliCa EMD configuration shadow register */
    void *   pKeyStoreDataParams;   /**< Pointer to the parameter structure of the keyStore layer. */
    uint32_t dwExpectedEvent;       /**< ExpectedEvent is used by Event Wait, to process cmd specific events. */
    uint16_t wCfgShadow[PHHAL_HW_PN76XX_SHADOW_COUNT];  /**< Configuration shadow; Stores configuration for current cardtype. */
    uint16_t wAdditionalInfo;       /**< Additional Information. */
    uint16_t wCurrentSlotCount;     /**< ISO 18000p3m3 slot count at time of buffer overflow (PH_ERR_SUCCESS_CHAINING). */
    uint8_t  bNonRF_Cmd;            /**< Command other then RF command*/
    uint8_t  bNfcipMode;            /**< Enable/Disable to handle start byte at 106kbps in NFCIP-1 mode. */
    ...
    uint16_t wTimingMode;           /**< Current timing measurement mode. */
    uint32_t dwTimingUs;            /**< PICC Current timing value. */
    uint8_t  bTimerDeviation;       /**< Platform timer diviation percentage. */
#endif /* NXPBUILD__PHHAL_HW_PN7642 */
}phhalHw_Pn76xx_DataParams_t, *pphhalHw_Pn76xx_DataParams_t;


/**
 * \brief This api is used to initialize the PN76xx hal
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phhalHw_Pn76xx_Init(phhalHw_Pn76xx_DataParams_t * pDataParams, /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams,                                       /**< [In] Size of the data parameter of the structure that was passed */
        void * pBalDataParams,                                            /**< [In] Pointer to the lower layer parameter(BAL) structure */
        void * pKeyStoreDataParams,                                       /**< [In] Pointer to the parameter structure of the keyStore layer. */
        uint8_t* pRdLibTxBuf,                                             /**< [In] Pointer to assign to  TX buffer */
...
phStatus_t phhalHw_Pn76xx_SetListenParameters(
                                              ...
                                              uint8_t * pSensRes,                          /**< [In] Pointer containing the address of 2 byte sens response for ISO14443- Type A. */
                                              uint8_t * pNfcId1,                           /**< [In] Pointer containing the address of  3 byte UID for ISO14443- Type A, first byte being 0x08. */
                                              uint8_t SelRes,                              /**< [In] Response to select i.e. sak for ISO14443- Type A. */
                                              uint8_t * pPollingResp,                      /**< [In] 2 bytes (shall be 01h, FEh) + 6 bytes NfcId2 + 8 bytes Pad + 2 bytes SystemCode. */
                                              uint8_t bNfcId3                              /**< [In] 1 byte. */
                                              );
...
#define PHHAL_HW_CONFIG_TIMING_MS                 0x8012U
    ...
    /**
    * Retrieve Platform timer deviation percentage.\n
    *
    * */
#define PHHAL_HW_CONFIG_TIMER_DEVIATION_PROXIMITY_CHECK           0x8013U
     ...
     *
     * Note: Before Setting FELICA_EMD bit, OpeMode need to be configured to #RD_LIB_MODE_FELICA.\n
     * */
...
#define PHHAL_HW_CONFIG_SET_FELICA_EMD_RC_BYTE_VAL                0x802CU
    ...
    /**
     * Enable (#PH_ON) or Disable (#PH_OFF) FeliCa EMD RC check on CRC correct.\n
     *
     * NOTE: This SetConfig is applicable only for PN5190 FW v02.02 and greater.
     * When this configuration is used, RC Check shall be done after receiving complete frame.
     * */
#define PHHAL_HW_CONFIG_SET_FELICA_EMD_RC_CHECK_ON_CRC_CORRECT    0x802DU

    /**
     * Enable (#PH_ON) or Disable (#PH_OFF) FeliCa EMD LOG Enable.\n
     *
     * NOTE: This SetConfig is applicable only for PN5190 FW v02.02 and greater.
     * When this configuration is set, Exchange shall return with PH_ERR_PN5190_TIMEOUT_WITH_EMD_ERROR error and FeliCa EMD
     * data can be retrieved using \ref PHHAL_HW_PN5190_INSTR_RETRIEVE_RF_FELICA_EMD_DATA Command.
     * */
#define PHHAL_HW_CONFIG_SET_FELICA_EMD_LOG_ENABLE                 0x802EU

    /**
     * Enable (#PH_ON) or Disable (#PH_OFF) FeliCa Rx Enable only feature to configure the FDT Timer accordingly.\n
     *
     * NOTE: This SetConfig is applicable only for PN5190 FW v02.02 and greater. \ref phhalHw_Exchange needs to be called
     * with wTxLength of Zero bytes to enter Receive mode by skipping Transmit cycle in FeliCa Reader Mode.
     * */
#define PHHAL_HW_CONFIG_SET_FELICA_RX_ONLY                        0x802FU
 ...
 */
     ...
     * Valid values are #PH_ON, #PH_OFF
     * */
#define PHHAL_HW_PN5190_CONFIG_CTS_EVENT_STATUS    PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC

    /**
     * Enable/Disable PN5190 CTS Event through IRQ Pin.
     * Valid values are #PH_ON, #PH_OFF
     * */
#define PHHAL_HW_PN5190_CONFIG_CTS_EVENT_ENABLE    PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC + 1
     ...
     *
     * */
#define PHHAL_HW_PN5190_CONFIG_LPCD_EVENT_ENABLE   PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC + 2

    /**
     * Configure the expected event when /ref phhalHw_EventWait
     * API is been called by User.
     *
     * Event the can be configured are /ref pn5190_events
     * */
#define PHHAL_HW_PN5190_CONFIG_EXPECTED_EVENT      PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC + 3

    /**
     * Set PN5190 RF ON Event Status.
     * Valid values are #PH_ON, #PH_OFF
     * */
#define PHHAL_HW_PN5190_CONFIG_RF_ON_EVENT_STATUS  PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC + 4

    /**
     * Configure which SWITCH_MODE_NORMAL Command of PN5190 needs to be sent to terminate an ongoing CMD execution.
     * Other supported values are\n
     * #PH_PN5190_SWITCH_MODE_NORMAL_2_1 : Shall turn OFF the RF Field and load Rx and Tx registers with Reset values. \n
     * #PH_PN5190_SWITCH_MODE_NORMAL_2_2 : Shall not turn OFF the RF Field and shall only load IDLE CMD. \n
     * */
#define PHHAL_HW_PN5190_CONFIG_ABORT_CMD           PHHAL_HW_CONFIG_CUSTOM_READER_SPECIFIC + 5
/**
 * @}
 */
#endif /* NXPBUILD__PHHAL_HW_PN5190 */
...
#ifdef NXPBUILD__PHHAL_HW_PN76XX
    phhalHw_Pn76xx_DataParams_t        sHal;                       /* HAL component holder for PN76xx */
#endif /* NXPBUILD__PHHAL_HW_PN76XX */
...
#include "../comps/phhalHw/src/PN76xx/phhalHw_PN76xx.h"

#define phhalHw_Exchange(pDataParams,wOption,pTxBuffer,wTxLength,ppRxBuffer,pRxLength) \
        phhalHw_Pn76xx_Exchange((phhalHw_Pn76xx_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength, ppRxBuffer, pRxLength)

#define phhalHw_ApplyProtocolSettings(pDataParams, bMode) \
        phhalHw_Pn76xx_ApplyProtocolSettings((phhalHw_Pn76xx_DataParams_t *)pDataParams, bMode)

#define phhalHw_SetConfig(pDataParams, wConfig, wValue) \
        phhalHw_Pn76xx_SetConfig((phhalHw_Pn76xx_DataParams_t *)pDataParams, wConfig, wValue)

#define phhalHw_MfcAuthenticateKeyNo(pDataParams, bBlockNo, bKeyType, wKeyNo, wKeyVersion,pUid) \
        phhalHw_Pn76xx_MfcAuthenticateKeyNo((phhalHw_Pn76xx_DataParams_t *)pDataParams,bBlockNo, bKeyType, wKeyNo, wKeyVersion, pUid)

#define phhalHw_MfcAuthenticate(  pDataParams, bBlockNo, bKeyType, pKey, pUid) \
        phhalHw_Pn76xx_MfcAuthenticate((phhalHw_Pn76xx_DataParams_t *)pDataParams,bBlockNo,bKeyType, pKey,pUid)

#define phhalHw_GetConfig(pDataParams, wConfig, pValue) \
        phhalHw_Pn76xx_GetConfig((phhalHw_Pn76xx_DataParams_t *)pDataParams, wConfig, pValue)

#define phhalHw_FieldOn(pDataParams) \
        phhalHw_Pn76xx_FieldOn((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_FieldOff(pDataParams) \
        phhalHw_Pn76xx_FieldOff((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_FieldReset(pDataParams) \
        phhalHw_Pn76xx_FieldReset((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_Wait(pDataParams, bUnit, wTimeout) \
        phhalHw_Pn76xx_Wait((phhalHw_Pn76xx_DataParams_t *)pDataParams, bUnit, wTimeout)

#define phhalHw_Transmit(pDataParams, wOption, pTxBuffer, wTxLength) \
        phhalHw_Pn76xx_Transmit((phhalHw_Pn76xx_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength)

#define phhalHw_Receive(pDataParams, wOption, ppRxBuffer, pRxLength) \
        phhalHw_Pn76xx_Receive((phhalHw_Pn76xx_DataParams_t *)pDataParams, wOption, ppRxBuffer, pRxLength)

#define phhalHw_Lpcd(pDataParams) \
        phhalHw_Pn76xx_Lpcd((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_AsyncAbort(pDataParams) \
        phhalHw_Pn76xx_AsyncAbort((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_Autocoll(pDataParams, wMode, ppRxBuffer, pRxLength, pProtParams) \
        phhalHw_Pn76xx_Autocoll((phhalHw_Pn76xx_DataParams_t *)pDataParams, wMode, ppRxBuffer,  pRxLength, pProtParams)

#define phhalHw_I18000p3m3Inventory(pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)\
        phhalHw_Pn76xx_I18000p3m3Inventory((phhalHw_Pn76xx_DataParams_t *)pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)

#define phhalHw_I18000p3m3ResumeInventory(pDataParams, ppRxBuffer, wRxBufferLen)\
        phhalHw_Pn76xx_18000p3m3ResumeInventory((phhalHw_Pn76xx_DataParams_t *)pDataParams, ppRxBuffer, wRxBufferLen)

#define phhalHw_DeInit(pDataParams) \
        phhalHw_Pn76xx_DeInit((phhalHw_Pn76xx_DataParams_t *)pDataParams)

#define phhalHw_EventWait(pDataParams, dwEventTimeout)  \
        phhalHw_Pn76xx_EventWait((phhalHw_Pn76xx_DataParams_t *)pDataParams, dwEventTimeout)

#define  phhalHw_EventConsume(pDataParams)  \
         phhalHw_Pn76xx_EventConsume((phhalHw_Pn76xx_DataParams_t *) pDataParams)
