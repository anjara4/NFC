...
typedef struct
{
    ...
    phhalHw_Pn76xx_DataParams_t        sHal;               /**< HAL component holder */
    ...
    phKeyStore_PN76XX_DataParams_t     sKeyStore;          /**< PN76XX Keystore component holder */
    ...
    phCryptoSym_mBedTLS_DataParams_t   sCryptoSymEnc;      /* Crypto Sym mbedtls component */
    phCryptoSym_mBedTLS_DataParams_t   sCryptoSymMac;      /* Crypto Sym mbedtls component */

    #ifdef NXPBUILD__PHAL_MFPEVX_SW
    phCryptoSym_mBedTLS_DataParams_t   sCryptoSymDiversify;/* Crypto Sym Diversify software component */
    #endif /* NXPBUILD__PHAL_MFPEVX_SW */
    ...
    /* Crypto Data Parameter Structures */
    #ifdef NXPBUILD__PH_CRYPTOSYM_MBEDTLS
    phCryptoSym_mBedTLS_DataParams_t   sCryptoSym;         /* Crypto Sym mbedtls component */
    #endif /* NXPBUILD__PH_CRYPTOSYM_MBEDTLS */
    ...
    phCryptoRng_mBedTLS_DataParams_t   sCryptoRng;         /* Crypto Rng component */
