 ...
 */
#define NUMBER_OF_KEYENTRIES        3u
...
//static phCryptoSym_mBedTLS_DataParams_t sCryptoSym_MbedTLS;
static phKeyStore_PN76XX_KeyEntry_t gpKeyEntries[NUMBER_OF_KEYENTRIES];
...
#ifdef NXPBUILD__PH_KEYSTORE_PN76XX
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phKeyStore_PN76XX_Init(
            PTR_sKeyStore,
            sizeof(phKeyStore_PN76XX_DataParams_t),
            &gpKeyEntries[0],
            NUMBER_OF_KEYENTRIES));

        /* Set Key Store with MIFARE Classic Key. */
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phKeyStore_FormatKeyEntry(PTR_sKeyStore, 1, 0x6));
        PH_CHECK_NFCLIB_INIT_FCT(wStatus,  phKeyStore_SetKey(PTR_sKeyStore, 1, 0, 0x6, &gphNfcLib_Key[0], 0));
#endif /* NXPBUILD__PH_KEYSTORE_PN76XX */
...
phNfcLib_Status_t phNfcLib_Init(void)
{
    ...
    memset(&gphNfcLib_State, 0x00, sizeof(phNfcLib_InternalState_t));
...
#ifdef NXPBUILD__PHHAL_HW_PN76XX
            /* Initialize the Pn7462AU HAL component */
            PH_CHECK_SUCCESS_FCT(wStatus, phhalHw_Pn76xx_Init(&gphNfcLib_Params.sHal,
                (uint16_t)(sizeof(phhalHw_Pn76xx_DataParams_t)),
                NULL,
                PH_NFCLIB_KEYSTORE_DATAPARAMS,
                gphNfcLib_State.bHalBufferTx,
                PH_NXPNFCRDLIB_CONFIG_HAL_TX_BUFFSIZE,
